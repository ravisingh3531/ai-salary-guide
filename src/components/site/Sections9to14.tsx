...
const roleRows: string[][] = [
  ...
  ["ML Engineer", "ML, DL, Python engineering, MLOps", "2+ yrs typical", "[VERIFY: source, month/year]", "LogicMojo, DeepLearning AI"],
  ...
  ["Data Scientist", "ML, statistics, communication", "0–3 yrs + portfolio", "[VERIFY: source, month/year]", "DataCamp, DeepLearning AI, LogicMojo"],
  ...
  ["AI Architect / Consultant", "Breadth, system design, communication", "Senior background", "[VERIFY: source, month/year]", "Simplilearn, DataCamp"],
  ...
  return (
    ...
    >
      <p>
        ...
        <strong>DeepLearning AI</strong> if what you are actually buying is placement infrastructure and you
        can fund and survive it; <strong>DataCamp or Great Learning</strong> if a university credential
